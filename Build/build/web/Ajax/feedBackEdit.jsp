    ...
    <div class="feedbackdetails">
      ${feedBackListIndividualId.subject}<br/>
        ${feedBackListIndividualId.content}<br/>
         ${feedBackListIndividualId.postedBy} | ${feedBackListIndividualId.regDate}   <a href="#!"  onclick="editFeedBack('${feedBackListIndividualId.subject}','${feedBackListIndividualId.content}',${feedBackListIndividualId.contactId},${feedBackListIndividualId.feedbackId})">Edit</a>
    </div>
</s:iterator>___
