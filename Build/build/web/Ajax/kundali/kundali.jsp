...
<c:if test="${kundali.resultId==0}">
    ...
    <c:if test="${ch==0}">
            ...
            <div class="text-center"> <input type="submit" class="btn btn-primary saveBtn" value="Calculate" onclick="calculateKundali(${boyContactId},${girlContactId})"></div>
...
<c:if test="${kundali.resultId>0}">
    ...
    <div class="totalnumber"><b>Total Guna Milan </b><span>${kundali.matchTotal}:</span> &nbsp;<b>  of 36</b></div>
    <div class="formDATA">
        <div class="text-left"> <label>${boyName}  :</label>  ${kundali.boyManglikString}</div>
        <div class="text-left"><label>${girlName}  :</label> ${kundali.girlManglikString}</div><br/>
        <br/>
    ...
    <div class="text-left"> <a href="#!" onclick="sentKundaliMail(${boyContactId},${girlContactId}, 1)"> Mail To</a>:<label>${boyName}  </label>  </div>
    <div class="text-left"> <a href="#!" onclick="sentKundaliMail(${boyContactId},${girlContactId}, 2)">Mail To</a>:<label>${girlName}  </label>  </div>
    <div class="text-left"><a href="#!" onclick="sentKundaliMail(${boyContactId},${girlContactId}, 3)"> Mail To</a>:<label>${boyName} & ${girlName}  </label>  </div>
    <div class="text-left"> <input type="submit" class="btn btn-primary saveBtn" value="Recalculate" onclick="calculateKundali(${boyContactId},${girlContactId})"></div>
    </c:if>
