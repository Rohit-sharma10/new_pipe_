...
<div class="col-lg-12 no-pad" id="ifollowupListIdTable">
    ...
    <s:iterator value="followupList" id="followupListId" >
        ...
        <div class="col-lg-2"><i class="fa fa-edit iconMargin" title="${followupListId.content}"></i>
            <i class="fa fa-refresh iconMargin"  href="#statusReschedule" title="reschedule" onclick="rescheduleFollowupStatusFinal(${followupListId.followupId})"></i>
            <i class="fa fa-trash-o iconMargin" title="close" onclick="showCloseFollowupStatusFinal(${followupListId.followupId},${followupListId.contactId})"></i>
        </div>
        </div>
        <div class="col-lg-12 no-pad" id="sfrescheduleSectiontr${followupListId.followupId}">
            <div id="sfrescheduleSectiontd${followupListId.followupId}">
                <section id="sfrescheduleSection${followupListId.followupId}">
