...
<div class="col-lg-12 no-pad" id="followupListIdTable">
    ...
    <s:iterator value="followupList" id="followupListId" >
        ...
        <div class="col-lg-2"><i class="fa fa-edit iconMargin" title="${followupListId.content}"></i>
            <i class="fa fa-refresh iconMargin" href="#statusReschedule" title="reschedule" onclick="rescheduleFollowup(${followupListId.followupId})"></i>
        ...
        <div class="col-lg-12 no-pad" id="rescheduleSectiontr${followupListId.followupId}">
            <div id="rescheduleSectiontd${followupListId.followupId}">
