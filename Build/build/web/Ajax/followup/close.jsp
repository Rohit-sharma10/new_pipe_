...
<div class="addfollowup addfollowupbg">
    ...
    <div class="formDATA controlWidth">
        ...
        <div class="controlsData controlWidth">
            <input type="hidden" id="ccontactId" value="<%=request.getParameter("contactId")%>"/>
            <input type="hidden" id="cfollowupId" value="<%=request.getParameter("followupId")%>"/>
            <input type="text" id="closeFollowupContent" class="closeinputwidth"/>
            <div class="followupgo">
                <input type="submit"  onclick="return closeFollowup()" value="Go" class="btn btn-go">
            </div>
        </div>
    </div>
</div>
