                ...
                <section class="wrapper">
                    <div class="row">
                        <div class="col-lg-12 marginTOP">
                            ...
                            <h4 class="candidateName">Edit Remark </h4>
                            <div class="row">
                                <div class="col-lg-12" >

                                    <form action="updateRemark" method="post" id="formId">                                       

                                        <input type="hidden" name="reasonBean.reasonId" value="${reasonBean.reasonId}"/>             

                                        <section class="formHalf">
                                            <div class="formDATA">
                                                <label>Remark Name</label>
                                                <div class="controlsData">
                                                    <input type="text" name="reasonBean.reason" value="${reasonBean.reason}" id="reason"/> 
                                            ...
                                            <div class="formDATA">
                                                ...
                                                <div class="controlsData">
                                                    <input type="text" name="reasonBean.shortCode" value="${reasonBean.shortCode}" id="shortCode"/>        
                                            ...
                                            <div class="formDATA">
                                                ...
                                                <div class="controlsData">
                                                    <s:select headerKey="0" headerValue="--- Select ---" cssClass="input_box" id="mainStatus"
                                                              ...
                                                              name="reasonBean.mainStatusId" value="%{reasonBean.mainStatusId}" />      
                                            ...
                                            <div class="formDATA">
                                                ...
                                                <div class="controlsData">
                                                    <select  id="yesOrNo" name="reasonBean.yesOrNo" >
                                                        ...
                                                        <option ${reasonBean.yesOrNo =="Y"?'selected':'' } value="Y">Yes</option>
                                                        <option ${reasonBean.yesOrNo =="N"?'selected':''} value="N">No</option>                                                     
                                                    </select> 
                                            ...
                                            <div class="formEdit" style="margin-right: 130px;margin-top: 18px;"><input type="submit" class="btn btn-primary saveBtn" value="submit" onclick="return editRemark()"/></div>
