                ...
                <section class="wrapper">
                    <div class="row">
                        <div class="col-lg-12 marginTOP">
                            ...
                            <h4 class="candidateName">Edit Office </h4>
                            <div class="row">
                                <div class="col-lg-12" >

                                    <form action="updateOffice" method="post" id="formId">                                       

                                        <input type="hidden" name="office.officeId" value="${office.officeId}"/>             

                                        <section class="formHalf">
                                            <div class="formDATA">
                                                <label>Office Name</label>
                                                <div class="controlsData">
                                                    <input type="text" name="office.officeName" value="${office.officeName}"id="officeName"/> 
                                            ...
                                            <div class="formDATA">
                                                ...
                                                <div class="controlsData">
                                                    <input type="text" name="office.address1" value="${office.address1}" id="address1"/>        
                                            ...
                                            <div class="formDATA">
                                                ...
                                                <div class="controlsData">
                                                    <s:select headerKey="0" headerValue="--- Select ---" cssClass="input_box" id="country"
                                                              ...
                                                              name="office.countryId" value="%{office.countryId}"  />      
                                            ...
                                            <div class="formDATA">
                                                ...
                                                <div class="controlsData">
                                                   <s:select headerKey="0" headerValue="--- Select ---" cssClass="input_box" id="city"
                                                              ...
                                                              name="office.cityId" value="%{office.cityId}"  /> 
                                            ...
                                            <div class="formDATA">
                                                <label>Mobile</label>
                                                <div class="controlsData">
                                                    <input type="text" name="office.mobile" value="${office.mobile}"id="mobile"/> 
                                            ...
                                            <div class="formDATA">
                                                <label>Email</label>
                                                <div class="controlsData">
                                                    <input type="text" name="office.email" value="${office.email}"id="email"/> 
                                        ...
                                        <section class="formHalf">
                                            <div class="formDATA">
                                                ...
                                                <div class="controlsData">
                                                    <input type="text" name="office.contactPerson" value="${office.contactPerson}" id="person"/> 
                                            ...
                                            <div class="formDATA">
                                                ...
                                                <div class="controlsData">
                                                    <input type="text" name="office.address2" value="${office.address2}" id="address2"/> 
                                            ...
                                            <div class="formDATA">
                                                ...
                                                <div class="controlsData">
                                                   <s:select headerKey="0" headerValue="--- Select ---" cssClass="input_box" id="state"
                                                              ...
                                                              name="office.stateId" value="%{office.stateId}"  /> 
                                            ...
                                            <div class="formDATA">
                                                <label>PinCode</label>
                                                <div class="controlsData">
                                                    <input type="text" name="office.pincode" value="${office.pincode}" id="pincode"/>
                                            ...
                                            <div class="formDATA">
                                                ...
                                                <div class="controlsData">
                                                    <input type="text" name="office.telephone" value="${office.telephone}"id="telephone"/> 
                                        ...
                                        <div class="formEdit" style="margin-right: 18px;margin-top: 18px;"><input type="submit" class="btn btn-primary saveBtn" value="submit" onclick="return editOffice()"/></div>
