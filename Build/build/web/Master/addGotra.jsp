                ...
                <section class="wrapper">
                    <div class="row">
                        <div class="col-lg-12 marginTOP">
                            ...
                            <h4 class="candidateName">Add Gotra</h4>
                            <div class="row">
                                <div class="col-lg-12" >

                                    <form action="saveGotra" method="post" id="formId">                                       
                                        <section class="formHalf">
                                            <div class="formDATA">
                                                <label>Gotra Name</label>
                                                <div class="controlsData">
                                                    <input type="text"  name="gotraBean.gotraName" id="gotraName" placeholder="Enter Gotra"/> 
