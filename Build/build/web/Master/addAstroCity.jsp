...
//                var regexp = /^[-,+]+[0-9,]+(\.\d{0,3})?$/;
                var regexp = /^[0-9,]+(\.\d{0,3})?$/;
//                if (longitude1 != '') {
//                    if (regexp1.test(longitude1) == false) {
//                        alert("Wrong Numbere");
//                        return false;
//                    }
//                    
//                } else {
//                    alert("Langitude can not be empty");
//                    return false;
//                }
                if (cityName === '')
                {
                ...
                <section class="wrapper">
                    <div class="row">
                        <div class="col-lg-12 marginTOP">
                            ...
                            <h4 class="candidateName"> Add Astro City </h4>
                            <div class="row">
                                <div class="col-lg-12">

                                    <form action="saveAstroCity" method="post" id="formId">                                       
                                        ...
                                        <section class="formHalf">
                                            <div class="formDATA">
                                                ...
                                                <div class="controlsData">
                                                    <input type="text" id="cityName" name="masterBean.astroCityName" placeholder="City Name" id="cityName"/>
                                            ...
                                            <div class="formDATA">
                                                ...
                                                <div class="controlsData">
                                                    <input type="text" name="masterBean.longitude" placeholder="Longitude" id="longitude"/> 
                                            ...
                                            <div class="formDATA">
                                                ...
                                                <div class="controlsData">
                                                    <input type="text" name="masterBean.latitude" placeholder="Latitude" id="latitude"/> 
                                            ...
                                            <div class="formDATA">
                                                <label>GMT</label>
                                                <div class="controlsData">
                                                    <input type="text" name="masterBean.gmtDiff" placeholder="GMT" id="gmt"/>  
                                        ...
                                        <section class="formHalf">
                                            <div class="formDATA">
                                                <label>Country</label>
                                                <div class="controlsData">
                                                    <s:select headerKey="0" headerValue="--- Select Country ---" cssClass="input_box" id="country"
                                                              list="countryList" listKey="AstroCountryId"  listValue="AstroCountryName" 
                                                              name="masterBean.countryId"   /> 
                                        ...
                                        <div class="formEdit" style="margin-right: 18px;margin-top: 18px;">
                                            ...
                                            <input type="submit" class="btn btn-primary saveBtn" value="submit" onclick="return addCity()"/></div>
                                    </form>
