                ...
                <section class="wrapper">
                    <div class="row">
                        <div class="col-lg-12 marginTOP">
                            ...
                            <h4 class="candidateName">City List</h4>
                            ...
                            <form action="fetchCityList" method="post">                                                                                                       
                                <div class="col-lg-2">
                                    <div class="formDATA">
                                        <div class="controlsData controlWidth">
                                            <input type="text" name="cityBean.cityName" value="${cityBean.cityName}" placeholder="City" id="city"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-2">
                                    <div class="formDATA"><button value="search" class="btn btn-primary" >Search</button></div>  </div>                                    
                                         ...
                                         <div class="col-lg-2"><div class="formDATA"><a href="addCity" ><button value="search" class="btn btn-primary" >Add City</button></a></div></div>                         
                            <div class="row">
                                <div class="col-lg-12" >                                   
                                    <h5>${message}</h5>
                                    <display:table   name="normalCityList"  id="cityListId" pagesize="15" export="true"  requestURI="" class="borderNoneTable tableBG uiTable postedTable" >                                                                                                    
                                        <display:column title="Name" property="cityName" sortable="true"/>
                                        <display:column title="Country" property="countryName" sortable="true"/>
                                         <display:column title="Edit" media="html" sortable="" style="width:5%;text-align:left" >
                                            <a href="editCity?cityId=${cityListId.cityId}">
                                        ...
                                        <display:column title="Delete" media="html" sortable="" style="width:5%;text-align:left" >
                                            <a href="deleteCity?cityId=${cityListId.cityId}">
                                         ...
                                         <display:setProperty name="paging.banner.placement" value="bottom"/>
                                            ...
                                            <display:setProperty name="export.csv.filename" value="city.csv"/>
                                            <display:setProperty name="export.excel.filename" value="city.xls"/>
                                            <display:setProperty name="export.excel" value="true" />     
                                            <display:setProperty name="export.xml" value="false" />
                                            <display:setProperty name="export.xml.filename" value="city.xml"/> 
                                    </display:table>   
