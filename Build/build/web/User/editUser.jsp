...
//                alert("Here" + officeId);
        ...
        <script>
            ...
            {
                var status = document.getElementById("status").value;
                document.getElementById("status").value = document.getElementById("statusField").value

                document.getElementById("module").value = document.getElementById("moduleField").value
            }
        </script>
    </head>
                            ...
                            <div class="row">
                                <div class="col-lg-12" >
                                    ...
                                    <form action="updateUser" method="post" id="formId">                                       
                                        ...
                                        <input type="hidden" name="userMaster.userId" value="${userMaster.userId}"/>
                                        <!--<input type="hidden" name="userBeans.officeId" value=""/>-->
                                            ...
                                            <div class="formDATA">
                                                ...
                                                <div class="controlsData">
                                                    <s:select headerKey="0" headerValue="--- Select ---" cssClass="input_box" id="officeListId"
                                                              ...
                                                              name="userMaster.officeId" value="%{userMaster.officeId}" cssStyle="width:190px;" onchange="getRMList(this.value)"/>
                                            ...
                                            <div class="formDATA">
                                                ...
                                                <div class="controlsData">
                                                    <s:select headerKey="0" headerValue="--- Select ---" cssClass="input_box" id="deptListId"
                                                              ...
                                                              name="userMaster.deptId" value="%{userMaster.deptId}" cssStyle="width:190px;"/>
                                            ...
                                            <div class="formDATA">
                                                ...
                                                <div class="controlsData">
                                                    <s:select headerKey="0" headerValue="--- Select ---" cssClass="input_box" id="rmListId"
                                                              list="simpleRMList" listKey="rmId"  listValue="rmName" 
                                                              name="userMaster.rmId" value="%{userMaster.rmId}" cssStyle="width:190px;"/>
                                                    <!--<label id="validateDeptListId" style="color:red!important;display:none!important; width:100%!important;">Please Select One</label>--> 
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <section class="formHalf">
                                            <div class="formDATA">
                                                ...
                                                <div class="controlsData">
                                                    <input type="text" name="userMaster.name" value="${userMaster.name}"id="contactName"/>
                                            ...
                                            <div class="formDATA">
                                                <label>Email</label>
                                                <div class="controlsData">
                                                    <input type="email" name="userMaster.userName" value="${userMaster.userName}" id="email"/>
                                            ...
                                            <div class="formDATA">
                                                ...
                                                <div class="controlsData">
                                                    <input type="password" name="userMaster.password" value="${userMaster.password}" id="password"/>
                                        ...
                                        <section class="formHalf">
                                            <div class="formDATA">
                                                ...
                                                <div class="controlsData">
                                                    <input type="text" name="userMaster.shortName" id="shortName" value="${userMaster.shortName}" maxlength="3"/>
                                            ...
                                            <div class="formDATA">
                                                ...
                                                <div class="controlsData">
                                                    <input type="text" name="userMaster.mobile" value="${userMaster.mobile}" id="mobile"/>
                                            ...
                                            <div class="formDATA">
                                                ...
                                                <div class="controlsData">
                                                    <input type="password" name="userMaster.confirmPassword"  value="${userMaster.password}" id="confirmPassword"/>
                                        ...
                                        <section class="formHalf">
                                            <div class="formDATA">
                                                ...
                                                <div class="controlsData">
                                                    <input type="text" name="userMaster.host" value="${userMaster.host}" id="serverName" />
                                            ...
                                            <div class="formDATA">
                                                ...
                                                <div class="controlsData">
                                                    <input type="email" name="userMaster.serverUserName" value="${userMaster.serverUserName}" id="userName"/>
                                        ...
                                        <section class="formHalf">
                                            <div class="formDATA">
                                                <label>Port</label>
                                                <div class="controlsData">
                                                    <input type="text" name="userMaster.port" value="${userMaster.port}"  id="port"/>
                                            ...
                                            <div class="formDATA">
                                                ...
                                                <div class="controlsData">
                                                    <input type="password" name="userMaster.serverPassword" value="${userMaster.serverPassword}" id="serverPassword"/>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="formDATA">
                                                <div class="controlsData">
                                                    <input type="checkbox" name="userMaster.assigned" value="1" <s:if test="userMaster.assigned==1">checked</s:if> id="assigned"/>&nbsp;&nbsp;Assigned
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="formDATA">
                                                    <div class="controlsData">
                                                        <input type="checkbox" name="userMaster.unassigned" value="1" <s:if test="userMaster.unassigned==1">checked</s:if> id="unassigned"/>&nbsp;&nbsp;Unassigned
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="formDATA">
                                                    <div class="controlsData">
                                                        <input type="checkbox" name="userMaster.all" value="1" <s:if test="userMaster.all==1">checked</s:if> id="all"/>&nbsp;&nbsp;All
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="formDATA">
                                                    <div class="controlsData">
                                                        <input type="checkBox" name="userMaster.kundaliper" value="1" <s:if test="userMaster.kundaliper==1">checked</s:if> id="kundaliPer"/>&nbsp;&nbsp; Kundali Permission 
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="formDATA">
                                                    <div class="controlsData">
                                                        <input type="checkBox" name="userMaster.pauseper" value="1" <s:if test="userMaster.pauseper==1">checked</s:if> id="pausePer"/>&nbsp;&nbsp; Pause Permission
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="formDATA">
                                                    ...
                                                    <s:select headerKey="0"  cssClass="input_box"  id="modulePer"
                                                              ...
                                                              name="userMaster.moduleaccess" value="%{userMaster.moduleArray}" style="height:90px!important;"/>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="formDATA">
                                                <label>Status</label>
                                                <input type="hidden" id="statusField" value="${userMaster.status}" />
                                                <div class="controlsData">
                                                    <select name="userMaster.status"  value="${userMaster.status}" id="status">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="formDATA">
                                                ...
                                                <div class="controlsData">
                                                    <input type="text" name="userMaster.expiryDate"  value="${userMaster.expiryDate}" id="datepicker" />
                                                    <label id="validateDate" style="color:red!important;display:none!important; width:100%!important;">Please enter Date</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="formEdit" style="margin-right: 18px;margin-top: 18px;"><input type="submit" class="btn btn-primary saveBtn" value="submit" onclick="return editUser()"/></div>
