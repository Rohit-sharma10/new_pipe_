<%-- 
    ...
    Created on : 27 Jul, 2016, 4:04:30 PM
    Author     : OpenSpace
--%>
<!DOCTYPE html>
<html>
                ...
                <section class="wrapper">
                    <div class="row">
                        <div class="col-lg-12 marginTOP">
                            <!--copy till here-->
                            <h4 class="candidateName">Meeting Report</h4>
                            <form action="searchMeetingList" method="post">                                                             
                                ...
                                <div class="col-lg-2">
                                    <div class="formDATA">
                                        <div class="controlsData controlWidth">                                          
                                            <input type="text" id="txtAutoComplete1" list="searchName" name="reportBean.search" value="${reportBean.search}"  placeholder="Posted To" /><!--your input textbox-->
                                            <!--<datalist id="searchName" >-->
                                            <%--<s:iterator value="meetingList" var="meetingListId">--%>
                                                <!--<option value="${meetingListId.contactFirstName} ${meetingListId.contactMiddleName} ${meetingListId.contactLastName} ${meetingListId.contactProfileId} ${meetingListId.contactCatNo}"> </option>-->
                                            <%--</s:iterator>--%>
                                            <!--</datalist>-->                                        
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-2">
                                    <div class="formDATA">
                                        <div class="controlsData controlWidth">                                          
                                            <input type="text" id="txtAutoComplete" list="searchName1" name="reportBean.search1" value="${reportBean.search1}" placeholder="Posted For" /><!--your input textbox-->
                                            <!--<datalist id="searchName1" >-->
                                            <%--<s:iterator value="meetingList" var="meetingListId">--%>
                                                <!--<option value="${meetingListId.matchFirstName} ${meetingListId.matchMiddleName} ${meetingListId.matchLastName} ${meetingListId.matchProfileId} ${shortListId.matchCatNo}"> </option>-->
                                            <%--</s:iterator>--%>
                                            <!--</datalist>-->                                        
                                        </div>
                                    </div>
                                ...
                                <display:table export="true" name="meetingList"  id="meetingListId"  pagesize="15"  requestURI="" class="borderNoneTable tableBG uiTable postedTable"  >                                                                                             
                                    ...
                                    <display:column title="Posted To" sortable="true"  style="width:50%;text-align:left"  media="html">
                                        <a href="getContactDetail?contactId=${meetingListId.contactId}">  ${meetingListId.fullContactName}</a>                                                                    
                                    </display:column>   
                                    ...
                                    <display:column title="Posted For" sortable="true"  style="width:50%;text-align:left"  media="html">
                                        <a href="getContactDetail?contactId=${meetingListId.matchId}">  ${meetingListId.fullMatchName}</a>                                                                    
                                    </display:column>
                                    ...
                                    <display:column title="Venue" property="venue" sortable="true" style="width:50%;text-align:left"/>
                                    ...
                                    <display:setProperty name="export.csv.filename" value="meetingReport.csv"/>
                                    <display:setProperty name="export.excel.filename" value="meetingReport.xls"/>
